...
/// Get the next seed to try. If there are no more seeds to try, it will exit the
/// process.
...
/// Save the grid to a folder by creating a new file or overwrite it, on error kills the
/// program.
