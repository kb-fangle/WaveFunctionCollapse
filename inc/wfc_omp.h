...
bool blk_propagate_omp(wfc_blocks_ptr blocks, uint32_t gx, uint32_t gy, uint64_t collapsed, position_list* collapsed_stack, omp_lock_t* stack_lock);
/// Propagate a collapsed state in a column.
bool grd_propagate_column_omp(wfc_blocks_ptr blocks, position loc, uint64_t collapsed, position_list* collapsed_stack, omp_lock_t* stack_lock);
/// Propagate a collapsed state in a row.
bool grd_propagate_row_omp(wfc_blocks_ptr blocks, position loc, uint64_t collapsed, position_list* collapsed_stack, omp_lock_t* stack_lock);
